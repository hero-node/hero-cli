...
let pathPrefix = runInDefault ? '..' : 'hero-cli'
...
let InterpolateHtmlPlugin = require(pathPrefix + '/lib/InterpolateHtmlPlugin')
let paths = global.paths
let options = global.options
// Note: defined here because it will be used more than once.
let cssFilename = 'static/css/[name].[contenthash:8].css'

let shouldUseRelativeAssetPaths = global.homePageConfigs.isRelativePath
// ExtractTextPlugin expects the build output to be flat.
// (See https://github.com/webpack-contrib/extract-text-webpack-plugin/issues/27)
// However, our output is structured with css, js and media folders.
// To have this structure working with relative paths, we have to use custom options.
let extractTextPluginOptions = shouldUseRelativeAssetPaths

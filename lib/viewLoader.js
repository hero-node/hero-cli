...
function treeObject(metaData) {
    ...
    var j, k, kLen, bindDirective, binds;
    ...
    for (idx = 0, len = keys.length; idx < len; idx++) {
        ...
        for (k = 0, kLen = binds.length; k < kLen; k++) {
            ...
            console.log(currentViewVariableName);
            console.log(bindDirective);
            console.log(heryBindKeys);
            console.log(expressions[bindDirective]);

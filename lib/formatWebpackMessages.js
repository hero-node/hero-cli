...
var isInteractive = process && process.stdout && process.stdout.isTTY;

if (!isInteractive) {
    console.warn('You may use special comments to disable some warnings.');
    console.warn('Use // eslint-disable-next-line to ignore the next line.');
    console.warn('Use /* eslint-disable */ to ignore all warnings in a file.');
}

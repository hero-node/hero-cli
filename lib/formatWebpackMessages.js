...
let isInteractive = process && process.stdout && process.stdout.isTTY
...
let friendlySyntaxErrorLabel = 'Syntax error:'
...
function formatMessage(message) {
  ...
  let errorText, cleanedLines, hasReachedDuplicateMessage
  ...
  if (lines[1].indexOf('Module build failed: ') === 0) {
    ...
    errorText = lines[1].substr('Module build failed: '.length)
    cleanedLines = []
    hasReachedDuplicateMessage = false

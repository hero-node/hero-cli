...
function createProxyServer(url, port) {
    ...
    app.use('/borrower-static/wallet/speed/:vpage', express.static('../speedloan/html', {
        maxAge: 0
    }));
    app.use('/borrower-static/wallet/speed/:vpage', express.static('../test', {
        maxAge: 0
    }));
    app.use('/borrower-static/wallet/:vpage', express.static('../borrower-app/html', {
        maxAge: 0
    }));
    app.use('/borrower-static/wallet/:vpage', express.static('../test', {
        maxAge: 0
    }));
    app.use('/borrower-static/cash/', express.static('../cash', {
        maxAge: 0
    }));
    app.use('/h5/:vpage', express.static('../cash-html/', {
        maxAge: 0
    }));
    app.use('/asset2cash', express.static('../../asset2cash/', {
        maxAge: 0
    }));
    app.use('/sample', express.static('../client', {
        maxAge: 0
    }));
    app.use('/', express.static('../cash-h5', {
        maxAge: 0
    }));
...
function her() {
    var servers = [
    { url: 'https://borrower-dev.dianrong.com', port: 3000 },
    { url: 'https://borrower-demo.dianrong.com', port: 3001 },
    { url: 'https://borrower.dianrong.com', port: 3002 },
    { url: 'https://www-dev.dianrong.com', port: 3003 },
    { url: 'https://www-demo.dianrong.com', port: 3004 },
    { url: 'https://www.dianrong.com', port: 3005 },
    { url: 'https://cashloan-dev.dianrong.com', port: 3006 },
    { url: 'https://cashloan-demo.dianrong.com', port: 3007 },
    { url: 'https://cashloan.dianrong.com', port: 3008 }
    ];
